...
export class LoginComponent implements OnInit {
  ...
  constructor(private _authService: SocialAuthService, private _userAtuhService: AuthService, private _route: Router,   private _snackBar: MatSnackBar) { }
  ...
  ngOnInit() {
    ...
    this._authService.authState.subscribe((userGoogle) => {
       ...
       */
      this._userAtuhService.postIdGoogle(this.google_id, this.user).subscribe((response:any) =>{
